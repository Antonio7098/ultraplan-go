...
func TestTechnicalHandbookPromptDryRunAndFlow(t *testing.T) {
	...
	for _, want := range []string{"Generate technical-handbook.md", "Selected evidence:", "Do not make final architecture decisions", "projects/proj/sprints/01-alpha/technical-handbook.md"} {
