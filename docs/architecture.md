...
For a multi-issue queue, every issue must finish its complete containing-QA ladder before the campaign continues. The campaign stops on the first non-passing repair result.
